...
```{r}
res.mca <- MCA(candy[ ,1:9], ncp = 5, graph = FALSE)
fviz_screeplot(res.mca, addlabels = TRUE, ylim = c(0, 45))

```
Dimensions 1 & 2 represent `r 39.1+13.5`% variation contained in the data. 
...
```
Some of the variables require more than 2 dimensions to represent all the variability.
